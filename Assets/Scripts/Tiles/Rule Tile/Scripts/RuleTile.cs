...
namespace UnityEngine
{
	...
	public class RuleTile : TileBase
	{
		...
		private static readonly int[, ] RotatedOrMirroredIndexes = { { 2, 4, 7, 1, 6, 0, 3, 5 }, // 90
		...
		private TileBase[] m_CachedTopNeighboringTiles = new TileBase[NeighborCount];
		...
		public class TilingRule
		{
			...
			public bool m_OtherNeighbors = false;
